...
public class SampleDAO extends AbstractDAO  //오 요건 extends로 상속 받았으니 그대로 쓰면됨
{
	...
	// 게시글의 리플 리스트를 가져오는 메소드입니다.
	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> selectBoardReplyList(Map<String, Object> map) throws Exception{
		return (List<Map<String, Object>>) selectList("sample.selectBoardReply", map);
	}
